...
export default function Contact() {
  return (
    <section
      id="contact"
      className="py-20 relative overflow-hidden bg-zinc-950"
    >
      ...
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            Let's discuss how I can contribute to your team's success with
            Salesforce.
          </motion.p>
          ...
          >
            ...
            <a
              href="https://www.linkedin.com/in/apeksha-shetti-5a30a7205/"
              target="_blank"
